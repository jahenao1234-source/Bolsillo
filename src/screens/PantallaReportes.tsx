...
export const PantallaReportes: React.FC<PantallaReportesProps> = ({
  ...
  return (
    <div className="space-y-5 pb-24 md:pb-12 max-w-5xl mx-auto animate-screen-enter">
      {/* Cabecera */}
      <header className="flex items-center justify-between gap-3 pt-1 no-imprimir">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-2xl font-bold font-display tracking-tight text-[color:var(--texto)]">Reportes</h1>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-2 rounded-xl bg-[var(--superficie)] border border-[var(--linea)] text-[13px] font-semibold text-[color:var(--texto)] focus:outline-none focus:border-[var(--acento)] cursor-pointer appearance-none"
          >
            {disponibles.map((d) => (
      ...
      {/* ===== La hoja: es lo que se imprime, y también lo que se ve ===== */}
      <div className="hoja-reporte space-y-5">
